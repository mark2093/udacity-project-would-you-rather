...
class AnswerAQuestion extends Component {
  ...
  handleSubmit = (e) => {
    ...
    if (answer) {
      console.log(answer)
      dispatch(handleQuestionPoll(authedUser, question.id, answer))
    }
  }
...
export default connect(mapStateToProps)(AnswerAQuestion)